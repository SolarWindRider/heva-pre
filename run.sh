...
ASCEND_RT_VISIBLE_DEVICES=0,3 nohup bash ./start.sh --exp_name exp001 -d VisuRiddles   -a 0.2 -n 300 -b 1 -s true -m 12288 -g 1 --heva_device npu:1 > VisuRiddles.out &
ASCEND_RT_VISIBLE_DEVICES=1,3 nohup bash ./start.sh --exp_name exp001 -d RAVEN         -a 0.2 -n 300 -b 1 -s true -m 12288 -g 1 --heva_device npu:1 > RAVEN.out &
ASCEND_RT_VISIBLE_DEVICES=2,3 nohup bash ./start.sh --exp_name exp001 -d MARVEL        -a 0.2 -n 300 -b 1 -s true -m 12288 -g 1 --heva_device npu:1 > MARVEL.out &
