...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="/home/ma-user/work/Downloads/Models/Qwen/Qwen3-VL-2B-Instruct")
    ...
    parser.add_argument("--truncate_text", type=int, default=300)
