...
# ============================================================
ASCEND_RT_VISIBLE_DEVICES=0 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset VisuRiddles   --use_attention_guidance true --use_context_aware false  > exp003_VisuRiddles.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=1 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset RAVEN         --use_attention_guidance true --use_context_aware false  > exp003_RAVEN.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=2 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset MARVEL        --use_attention_guidance true --use_context_aware false  > exp003_MARVEL.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=3 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset LogicVista    --use_attention_guidance true --use_context_aware false  > exp003_LogicVista.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=4 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset PuzzleVQA     --use_attention_guidance true --use_context_aware false  > exp003_PuzzleVQA.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=5 nohup python 3_run_inference_trace.py --exp_name exp003 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Instruct --dataset AlgoPuzzleVQA --use_attention_guidance true --use_context_aware false  > exp003_AlgoPuzzleVQA.out 2>&1 &
