...
ASCEND_RT_VISIBLE_DEVICES=0 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset VisuRiddles     > exp011_VisuRiddles.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=1 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset RAVEN > exp011_RAVEN.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=2 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset MARVEL > exp011_MARVEL.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=3 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset LogicVista > exp011_LogicVista.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=4 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset PuzzleVQA > exp011_PuzzleVQA.out 2>&1 &
ASCEND_RT_VISIBLE_DEVICES=5 nohup python 2_run_inference_heva_force.py --exp_name exp011 --model_path ../Downloads/Models/Qwen/Qwen3-VL-2B-Thinking --dataset AlgoPuzzleVQA > exp011_AlgoPuzzleVQA.out 2>&1 &
